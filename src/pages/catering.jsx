...
import "../styles/catering.css"; // ✅ CORRECT
...
const cateringData = [
  {
    title: "Veg Catering",
    description:
      "Authentic South Indian vegetarian meals with rich spices and homely warmth.",
    image: vegImg,
    path: "/menu/veg",
  },
  {
    ...
    description:
      "Experience aromatic non-veg dishes including biryanis, curries, and more.",
    image: nonvegImg,
    path: "/menu/nonveg",
  },
  {
    ...
    description:
      "Daily tiffin service offering balanced and tasty meals with regional flavors.",
    image: tiffinImg,
    path: "/menu/tiffins",
  },
  {
    title: "Sweets",
    description:
      "Delightful Indian sweets for all occasions — made with love and tradition.",
    image: sweetsImg,
    path: "/menu/sweets",
  },
];
